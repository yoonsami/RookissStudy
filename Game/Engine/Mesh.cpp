...
void Mesh::Create(vector<Vertex>& vertexBuffer, vector<uint32>& indexBuffer)
{
...
shared_ptr<Mesh> Mesh::CreateFromFBX(const struct FbxMeshInfo* meshInfo, class FBXLoader& loader)
{
